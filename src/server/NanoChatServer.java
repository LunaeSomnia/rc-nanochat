...
public class NanoChatServer implements Runnable {
    ...
    private static final int MYPROTOCOL = 10;
    ...
    private NanoChatServer(InetSocketAddress a) {
        ...
        //// TO!DO Registramos una sala de chat en el servidor (subclase de
        //// NCRoomManager)
        //// TO!DO manager.registerRoomManager();
        manager.registerRoomManager(new NCRoom(NCServerManager.ROOM_SIZE));
    }
    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                // Se inicia un thread por cada conexión que recibe el Manager compartido y el
                // socket por el que debe comunicarse
    ...
    public void init() {
        ...
        // Después tenemos que registrar el servidor en el directorio para que los
        // clientes lo puedan encontrar
        try {
    ...
    public static void main(String[] args) throws IOException {
        // Verificamos que se nos proporcionan los parámetros necesarios, en este caso
